...
export const AUTH_GUARD_ERRORS = {
	COOKIE_NOT_FOUND: "AUTH_GUARD_COOKIE_NOT_FOUND_ERROR",
	INVALID_TOKEN: "AUTH_GUARD_INVALID_TOKEN_ERROR",
	UNREACHABLE_AUTH: "AUTH_GUARD_UNREACHABLE_AUTH_ERROR",
};

export const AUTH_PRE_HANDLER_ERRORS = {
	USER_INFO_NOT_FOUND: "AUTH_PRE_HANDLER_USER_INFO_NOT_FOUND_ERROR",
	FORBIDDEN_RESOURCE: "AUTH_PRE_HANDLER_FORBIDDEN_RESOURCE_ERROR",
	FORBIDDEN_QUERY: "AUTH_PRE_HANDLER_FORBIDDEN_QUERY_ERROR",
	RESOURCE_NOT_FOUND: "AUTH_PRE_HANDLER_RESOURCE_NOT_FOUND_ERROR",
};
...
export const BLOCK_LIST_ERRORS = {
	SELF: "BLOCK_LIST_SELF_ERROR",
	ALREADY: "BLOCK_LIST_ALREADY_ERROR",
	NOT_FOUND: "BLOCK_LIST_NOT_FOUND_ERROR",
	GET: "GET_BLOCK_LIST_ERROR",
	ADD: "ADD_BLOCK_LIST_ERROR",
	DELETE: "DELETE_BLOCK_LIST_ERROR",
	// NOT_FOUND: "USER_NOT_FOUND",
	// ALREADY_EXISTS: "FIELD_VALUE_ALREADY_EXISTS",
	// INVALID_KEY: "INVALID_FOREIGN_KEY",
};
