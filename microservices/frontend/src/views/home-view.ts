...
class HomeView extends HTMLElement {
  ...
  handlePlayButtons(button: HTMLButtonElement) {
    ...
    console.log("HANDLE PLAY BUTTON -> check passed, button id:", button.id);
  ...
  connectedCallback() {
    ...
    this.modeContent.classList.add(...this.contentStyles, "grow-1", "w-full");
    this.playContent.classList.add(...this.contentStyles, "grow-1", "w-full");
